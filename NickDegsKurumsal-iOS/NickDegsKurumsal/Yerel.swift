...
final class Yerel: ObservableObject {
    ...
    static let S: [String:[String:String]] = [
        ...
        "incele": ["tr":"İncele","en":"View","de":"Ansehen","fr":"Voir","es":"Ver","ar":"عرض","ru":"Смотреть"],
        "planDahil": ["tr":"Abonelikle açılır","en":"Unlocked with subscription","de":"Mit Abo freigeschaltet","fr":"Débloqué avec l'abonnement","es":"Se desbloquea con la suscripción","ar":"يُفتح بالاشتراك","ru":"Открывается по подписке"],
        ...
        "sekme_isletmeler": ["tr":"İşletmeler","en":"Businesses","de":"Branchen","fr":"Secteurs","es":"Sectores","ar":"الأعمال","ru":"Сферы"],
        "sekme_isletme": ["tr":"Çözümler","en":"Solutions","de":"Lösungen","fr":"Solutions","es":"Soluciones","ar":"الحلول","ru":"Решения"],
