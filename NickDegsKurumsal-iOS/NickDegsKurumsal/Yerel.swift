...
final class Yerel: ObservableObject {
    ...
    static let S: [String:[String:String]] = [
        ...
        "heroAlt": ["tr":"Bireysel, içerik üretici ve kurumsal çözümler — hepsi NickDegs altyapısında.","en":"Personal, creator and enterprise solutions — all on NickDegs infrastructure."],
        ...
        "sekme_bireysel": ["tr":"Bireysel","en":"Personal"],
        "sekme_icerik": ["tr":"İçerik Üretici","en":"Creator"],
        "sekme_kurumsal": ["tr":"Kurumsal","en":"Business"],
        "kat_bireysel": ["tr":"Bireysel Ürünler","en":"Personal Products"],
